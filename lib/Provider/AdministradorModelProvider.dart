...
final administradorProvider = StateNotifierProvider<AdministradorModelProvider, List<AdministradorModel>>((ref) {
  return AdministradorModelProvider([]); 
});
